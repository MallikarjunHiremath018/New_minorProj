...
<header>
    ...
    <div class="container">
        ...
        <div class="button-container">
            <div class="button-with-image">
                <img src="./asstes/file.jpg" alt="View Image" class="img-fluid demo-image">
                <button class="btn btn-primary" onclick="viewData()">Add Files</button>
            </div>

            <!-- Sort Button with Image -->
            <div class="button-with-image">
                <img src="./asstes/sort.jpg" alt="Sort Image" class="img-fluid demo-image">
                <button class="btn btn-secondary" onclick="sortData()">Analyze</button>
            </div>

            <!-- View Graph Button with Image -->
            <div class="button-with-image">
                <img src="./asstes/graph.jpg" alt="Graph Image" class="img-fluid demo-image">
                <button class="btn btn-info" onclick="viewGraph()">View statics</button>
            </div>
        </div>
    ...
    <script>
        ...
        function viewData() {
            ...
            document.getElementById('dynamic-content').innerHTML = '<p> please select Data...</p> <input type="file">';
        }

        function sortData() {
            // Example: Replace this with your logic to sort data
            document.getElementById('dynamic-content').innerHTML = '<p>Analysing Data...</p>';
        }

        function viewGraph() {
            // Example: Replace this with your logic to display a graph
            document.getElementById('dynamic-content').innerHTML = '<p>Generating statistics...</p>';
        }
    </script>
</body>
</html>
